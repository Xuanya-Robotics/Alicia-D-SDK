...
xmlr.reflect(Capsule, tag="capsule", params=[xmlr.Attribute("radius", float), xmlr.Attribute("length", float)])
...
class GeometricType(xmlr.ValueType):
    def __init__(self):
        self.factory = xmlr.FactoryType(
            "geometric", {"box": Box, "cylinder": Cylinder, "sphere": Sphere, "mesh": Mesh, "capsule": Capsule}
        )
